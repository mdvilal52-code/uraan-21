...
export default function AnnouncementBar() {
  return (
    <div className="bg-[#0B1E42] px-3 py-2">
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-0.5 text-center font-poppins text-[#F7F3E8] md:flex-row md:gap-0">
        ...
        <p className="text-[10px] sm:text-[11px] font-medium uppercase tracking-[0.1em] leading-snug before:mx-1.5 before:text-[#C9A24A] before:content-['•'] md:before:mx-2">
