...
export function orderUpdateMessage(order: {
  ...
  return (
    `Namaste ${order.customer}, this is Om Gauri Pooja Gems Jewellery & Rudraksh. ` +
...
export function leadReplyMessage(name: string): string {
  ...
  return (
    `Namaste ${first}, thank you for reaching out to Om Gauri Pooja Gems Jewellery & Rudraksh. ` +
