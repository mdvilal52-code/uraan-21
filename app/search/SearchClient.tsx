...
// initialQuery arrives as a server-rendered prop (page.tsx reads it from its
// `searchParams` prop) instead of the useSearchParams() hook — that hook
// forces this whole subtree behind a Suspense boundary with no useful
// fallback, which blocked the entire page (navbar, heading, results) from
// painting until client JS fully hydrated. Same fix as /collections.
